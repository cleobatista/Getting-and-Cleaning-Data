...
## Following below answers the questions of the assignment as described below:
...
## check you can read the tidyset if you wished
read_tidy_set <- function(path_to_tidyset_file) {
  tidy_set <- read.table(path_to_tidyset_file)
  
  return (tidy_set)
}
## run the cmd below to read the tidyset inside the text file
